<div class="room-featured-items">
	<div class="row">
		<div class="col-xs-6 col-md-3">
			...
			<?php echo sprintf( __( 'S: %s', 'traveler' ), get_post_meta( get_the_ID(), 'campsite-type-143', true ) ) ?><?php echo __( 'm<sup>11</sup>', 'traveler' ); ?>
			</div>
		</div>
		<div class="col-xs-6 col-md-3">
			<div class="item has-matchHeight">
			<?php echo TravelHelper::getNewIcon( 'ico_beds_blue', '', '32px' ); ?>
			<?php echo sprintf( __( 'Beds: %s', 'traveler' ), get_post_meta( get_the_ID(), 'rental_bed', true ) ) ?><?php echo __( 'm<sup>11</sup>', 'traveler' ); ?>
			</div>
		</div>
		<div class="col-xs-6 col-md-3">
			<div class="item has-matchHeight">
