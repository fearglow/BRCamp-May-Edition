            ...
            <div class="content-item-left">
                ...
                <div class="amenities d-flex align-items-center clearfix">
                    ...
                    <span class="amenity d-flex align-items-center" data-bs-toggle="tooltip" title="<?php echo esc_attr__('Site Dimensions', 'traveler'); ?>">
                        ...
                        <?php
                        // Retrieve terms associated with the current post for the 'site-dimensions' taxonomy
                        $terms = get_the_terms(get_the_ID(), 'site-dimensions'); // Ensure 'site-dimensions' is the correct taxonomy name
                        if (!empty($terms) && !is_wp_error($terms)) {
                            // Assuming there's only one 'Site Dimensions' term per post
                ...
                <div class="price-wrapper " itemprop="priceRange">
                    <?php if (!empty($info_price['discount']) && $info_price['discount'] > 0 && $info_price['price_new'] > 0) : ?>
                        <div class="price-regular">
                            <span>
                                <?php echo esc_html(TravelHelper::format_money($orgin_price), 'traveler'); ?>
                            </span>
                        </div>
                    <?php endif; ?>
